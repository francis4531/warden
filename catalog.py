...
'sample':     ships with Warden for trying things out (fake customers, a knowledge base,
              tickets, refunds). Admins see it; regular users only if an admin put some of
              its tools in the studio defaults.
